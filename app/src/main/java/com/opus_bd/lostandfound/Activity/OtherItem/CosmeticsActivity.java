...
public class CosmeticsActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
 ...
 /*   PrimaryInformation*/
    ...
    public void Submit(){
        ...
        model.setProductTypeId(spnCosmeticsType.getSelectedItemPosition());
        model.setBrandTypeId(spnCosmeticsBrandType.getSelectedItemPosition());
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    if (response.body() != null) {
                        Toast.makeText(CosmeticsActivity.this, "Successfully Done!", Toast.LENGTH_SHORT).show();
                        CodeGenerateActivity.code = response.body().toString();
                        Intent intent = new Intent(CosmeticsActivity.this, CodeGenerateActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(CosmeticsActivity.this, "Invalid Credentials!", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(CosmeticsActivity.this, "Something went Wrong! Please try again later", Toast.LENGTH_SHORT).show();
                }

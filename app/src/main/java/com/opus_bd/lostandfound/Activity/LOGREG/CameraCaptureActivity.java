...
public final class CameraCaptureActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        CustomListeners.setBitmapGeneratedListener(new CustomListeners.BitmapGeneratedListener() {
            @Override
            public void onBitmapGenerated(Bitmap image) {
                capturedBitmap = image;

                onBackPressed();
                CustomListeners.imageReceiverListener_.onBitmapFound(image);
            }
        });
    ...
    private void requestCameraPermission() {
        ...
        Snackbar.make(mGraphicOverlay, "PERM CAM",

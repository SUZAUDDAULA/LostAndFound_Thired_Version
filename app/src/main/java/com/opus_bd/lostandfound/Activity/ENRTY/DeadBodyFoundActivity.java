...
import com.opus_bd.lostandfound.Model.PhysicalInfo.DeadbodyCondition;
...
public class DeadBodyFoundActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    public Integer SELECTED_EYE_TYPE_ID, SELECTED_NOSE_TYPE_ID, SELECTED_HAIR_TYPE_ID, SELECTED_FOREHEAD_TYPE_ID, SELECTED_BEARD_TYPE_ID,
            ...
            SELECTED_NECK_ID, SELECTED_TEETH_ID, SELECTED_RELIGION_ID, SELECTED_DEAD_BODY_CONDITION_ID, SELECTED_BODY_STRUCTURE_ID;
    ...
    public Integer SELECTED_INBODY_ID, SELECTED_INHEAD_ID, SELECTED_INEYE_ID, SELECTED_INTHROAT_ID, SELECTED_INWAIST_ID, SELECTED_INLEGS_ID,
            SELECTED_DEYE_COLOR_ID, SELECTED_DBODY_COLOR_ID, SELECTED_DHEAD_COLOR_ID, SELECTED_DWAIST_COLOR_ID, SELECTED_DTHROAT_COLOR_ID, SELECTED_DLEG_COLOR_ID;
    public Integer SELECTED_GENDER_ID, SELECTED_DOC_TYPE_ID, SELECTED_NUMBER_TYPE_ID, SELECTED_BIRTH_MARK_BODY_PART_POSITION_ID, SELECTED_BIRTH_MARK_BODY_PART_ID, SELECTED_BIRTH_MARK_ID;
    @BindView(R.id.etVisibleTattoos)
    EditText etVisibleTattoos;
    @BindView(R.id.etidentification_mark)
    EditText etidentification_mark;
    ...
    Spinner spnDLegMT;
    ArrayList<DNAProfileViewModel> dnaProfileViewModels = new ArrayList<>();
    //Image
...
//                    progress.dismiss();
                    ...
                    addDeadBodyConditionSpinnerData(response.body().getDeadbodyConditions());
  ...
  /*  @OnClick({R.id.ivDNAProfile, R.id.btnNext4})
    ...
    public void ReportShown() {
        ...
        try {
            ...
            tvIdentityficationMark.setText(etidentification_mark.getText().toString());
...
//        startActivity(intent);
    ...
    private void submitToServer() {
        ...
        model.setDeathOfDate("2020-06-02");
        model.setDeadbodyConditionId(SELECTED_DEAD_BODY_CONDITION_ID);
        ...
        model.setWeight(Double.parseDouble(etWeight.getText().toString()));
        ...
        model.setHeightFeet(Double.parseDouble(etFeet.getText().toString()));
        model.setHeightInch(Double.parseDouble(etInches.getText().toString()));
        ...
        model.setIdentifySign(etidentification_mark.getText().toString());
        //Dress
        ...
        model.setLafTime(etfoundTime.getText().toString());
    ...
    public void addBodyStuctureSpinnerData(final List<BodyStructure> body) {
        ...
        ArrayAdapter<String> dataAdapter2 = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_spinner_item, lstData);
        dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spnphysical_constitution.setAdapter(dataAdapter2);
        spnphysical_constitution.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                try {
                    if (i >= 1) {
    ...
    public void addDeadBodyConditionSpinnerData(final List<DeadbodyCondition> body) {
        List<String> lstData = new ArrayList<>();
        lstData.add(0, selectOne);
        if (Language == english) {
            for (int i = 0; i < body.size(); i++) {
        ...
        ArrayAdapter<String> dataAdapter2 = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_spinner_item, lstData);
        dataAdapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spnDeadBodyCondition.setAdapter(dataAdapter2);
        spnDeadBodyCondition.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                try {
                    if (i >= 1) {
                        SELECTED_DEAD_BODY_CONDITION_ID = body.get(i - 1).getId();
                    } else {
                        SELECTED_DEAD_BODY_CONDITION_ID = null;
                    }
                } catch (Exception e) {
                    Utilities.showLogcatMessage(" " + e.toString());
                }
    ...
    public void addColorSpinnerData(final List<Colors> body) {
        ...
        spnDBodyColor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (i >= 1) {
                    SELECTED_DBODY_COLOR_ID = body.get(i - 1).getId();
                } else {
                    SELECTED_DBODY_COLOR_ID = null;
                }
            }
    ...
    public void addDistrictSpinnerDataLP(final List<District> body) {
        ...
        spnSPDistrict.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                try {
                    if (i >= 1) {
                        SELECTED_DISTRICT_ID_LP = body.get(i - 1).getId();

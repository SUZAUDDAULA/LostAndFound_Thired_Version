...
public class JewelryActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    @BindView(R.id.spnJewelryType)
    Spinner spnJewelryType;

    @BindView(R.id.spnjwlaryFor)
    Spinner spnjwlaryFor;
    ...
    public void Submit(){
        ...
        // spnJewelryType model.(spnJewelryType.getSelectedItemPosition());
        // spnjwlaryFor model.(spnjwlaryFor.getSelectedItemPosition());
        model.setBrandTypeId(spnbrand.getSelectedItemPosition());


        model.setPrice(Double.valueOf(etPrice.getText().toString()));
        model.setModel(etModel.getText().toString());
        // etWeight model.(etWeight.getText().toString());
        // etCarat model.setEmcProductId(etCarat.getText().toString());
        ...
        registrationRequest.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    if (response.body() != null) {
                        Toast.makeText(JewelryActivity.this, "Successfully Done!", Toast.LENGTH_SHORT).show();
                        CodeGenerateActivity.code = response.body().toString();
                        Intent intent = new Intent(JewelryActivity.this, CodeGenerateActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(JewelryActivity.this, "Invalid Credentials!", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(JewelryActivity.this, "Something went Wrong! Please try again later", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<String> call, Throwable t) {
                ...
                Toast.makeText(JewelryActivity.this, "Fail to connect " + t.toString(), Toast.LENGTH_SHORT).show();

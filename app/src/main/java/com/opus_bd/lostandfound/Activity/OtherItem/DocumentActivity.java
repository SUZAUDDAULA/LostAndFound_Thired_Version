...
*/
    ...
    public void Submit() {
        ...
        model.setDocumentTypeId(spnDocType.getSelectedItemPosition());
        // document number   model.(etDocNumber.getText().toString());
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    if (response.body() != null) {
                        Toast.makeText(DocumentActivity.this, "Successfully Done!", Toast.LENGTH_SHORT).show();
                        CodeGenerateActivity.code = response.body().toString();
                        Intent intent = new Intent(DocumentActivity.this, CodeGenerateActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(DocumentActivity.this, "Invalid Credentials!", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(DocumentActivity.this, "Something went Wrong! Please try again later", Toast.LENGTH_SHORT).show();
                }

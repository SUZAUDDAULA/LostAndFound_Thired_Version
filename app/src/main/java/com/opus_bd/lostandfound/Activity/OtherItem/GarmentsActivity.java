...
public class GarmentsActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    @BindView(R.id.spnGarmentsType)
    Spinner spnGarmentsType;
    ...
    public void Submit(){
        ...
        //spnGarmentsType model.(spnGarmentsType.getSelectedItemPosition());
        ...
        registrationRequest.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    if (response.body() != null) {
                        Toast.makeText(GarmentsActivity.this, "Successfully Done!", Toast.LENGTH_SHORT).show();
                        CodeGenerateActivity.code = response.body().toString();
                        Intent intent = new Intent(GarmentsActivity.this, CodeGenerateActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(GarmentsActivity.this, "Invalid Credentials!", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(GarmentsActivity.this, "Something went Wrong! Please try again later", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<String> call, Throwable t) {
                ...
                Toast.makeText(GarmentsActivity.this, "Fail to connect " + t.toString(), Toast.LENGTH_SHORT).show();
...
//Date Picker
    ...
    void showDate(int year, int monthOfYear, int dayOfMonth, int spinnerTheme) {
        new SpinnerDatePickerDialogBuilder()
                .context(this)
                .callback(GarmentsActivity.this)

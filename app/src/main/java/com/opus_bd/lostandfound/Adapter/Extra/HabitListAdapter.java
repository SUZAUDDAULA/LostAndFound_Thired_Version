...
public class HabitListAdapter extends RecyclerView.Adapter<HabitListAdapter.TransactionViewHolder> {
    private final Context context;
    private List<String> items;

    public HabitListAdapter(List<String> items, Context context) {
        this.items = items;

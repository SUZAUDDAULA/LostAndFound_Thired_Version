...
public class SpeechListAdapter extends RecyclerView.Adapter<SpeechListAdapter.TransactionViewHolder> {
    private final Context context;
    private List<String> items;

    public SpeechListAdapter(List<String> items, Context context) {
        this.items = items;

...
public class AgePeriod {
    ...
    @SerializedName("periodNameBn")
    @Expose
    private String periodNameBn;
    ...
    public String getPeriodNameBn() {
        return periodNameBn;
    }

    public void setPeriodNameBn(String periodNameBn) {
        this.periodNameBn = periodNameBn;
    }
